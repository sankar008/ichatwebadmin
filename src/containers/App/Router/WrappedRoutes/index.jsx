...
import TablePage from '../../../Landing/TablePage';
import FormPage from '../../../Landing/FormPage';
...
export default () => (
  <div>
    ...
    <ContainerWrap>
      ...
      <Route path="/table_page" component={TablePage} />
      <Route path="/form_page" component={FormPage} />
